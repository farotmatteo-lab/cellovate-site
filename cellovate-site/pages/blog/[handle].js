    ...
    <>
      ...
      <main className="min-h-screen bg-[#FAFAFA] text-[#0A0A0A] font-sans pb-20">
        <style>{`
          ...
          .article-body p { margin-bottom: 1rem; line-height: 1.75; color: rgba(10,10,10,0.72); font-size: 14.5px; }
          .article-body hr { border-color: rgba(10,10,10,0.1); margin: 1.75rem 0; }
          .article-body ul { margin: 0 0 1rem 1.25rem; list-style: disc; color: rgba(10,10,10,0.72); font-size: 14.5px; }
          .article-body li { margin-bottom: 0.4rem; }
          .article-body strong { color: #0A0A0A; font-family: 'Space Grotesk', sans-serif; font-size: 13px; text-transform: uppercase; letter-spacing: 0.08em; }
